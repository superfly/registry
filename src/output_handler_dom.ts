...
// This file is intentionally decoupled from output_handler.ts, so the dom
// output handler can be loaded without pulling in preact.
...
export class OutputHandlerDOM implements OutputHandler {
  ...
  private vega(spec: vega.Spec, config: vega.Config = {}) {
